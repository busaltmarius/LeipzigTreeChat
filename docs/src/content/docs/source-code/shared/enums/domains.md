---
title: shared/enums/domains
description: Auto-generated source code reference for packages/shared/src/enums/domains.ts.
---

> This page is auto-generated from TSDoc output. Edit the source file, not this Markdown.

# `shared/enums/domains`

- Package: `@leipzigtreechat/shared`
- Source file: `packages/shared/src/enums/domains.ts`

## Summary

The domains in the Qanary knowledge graph
...
**Properties**
- `Measurand` (enum-member)
- `Station` (enum-member)
- `Calculation` (enum-member)
- `Representation` (enum-member)
- `Time` (enum-member)
**Defined at**: line 2
