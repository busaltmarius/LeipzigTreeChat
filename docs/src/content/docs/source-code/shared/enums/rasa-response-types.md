---
title: shared/enums/rasa-response-types
description: Auto-generated source code reference for packages/shared/src/enums/rasa-response-types.ts.
---

> This page is auto-generated from TSDoc output. Edit the source file, not this Markdown.

# `shared/enums/rasa-response-types`

- Package: `@leipzigtreechat/shared`
- Source file: `packages/shared/src/enums/rasa-response-types.ts`
...
**Properties**
- `Text` (enum-member): Response with text
- `Image` (enum-member): Response with an image as URL
**Defined at**: line 2
