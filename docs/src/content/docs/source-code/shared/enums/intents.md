---
title: shared/enums/intents
description: Auto-generated source code reference for packages/shared/src/enums/intents.ts.
---

> This page is auto-generated from TSDoc output. Edit the source file, not this Markdown.

# `shared/enums/intents`

- Package: `@leipzigtreechat/shared`
- Source file: `packages/shared/src/enums/intents.ts`
...
**Properties**
- `ACTION_DEFAULT_QANARY` (enum-member)
**Defined at**: line 4
