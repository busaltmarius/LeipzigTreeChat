---
title: shared/interfaces/representation
description: Auto-generated source code reference for packages/shared/src/interfaces/representation.ts.
---
...
- `type` (REPRESENTATION_TYPE): the type of the representation
**Defined at**: line 6
