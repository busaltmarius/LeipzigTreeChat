---
title: qanary-component-helpers/utils/question-uri-query
description: Auto-generated source code reference for packages/qanary-component-helpers/src/utils/question-uri-query.ts.
---

> This page is auto-generated from TSDoc output. Edit the source file, not this Markdown.

# `qanary-component-helpers/utils/question-uri-query`

- Package: `@leipzigtreechat/qanary-component-helpers`
- Source file: `packages/qanary-component-helpers/src/utils/question-uri-query.ts`
...
function getQuestionUriQuery(inGraph: string): void
...
**Parameters**
- `inGraph` (string): the graph to get the question uri from
**Defined at**: line 6
