...
export type IQanaryComponentHealthStatusEnum =
  (typeof IQanaryComponentHealthStatusEnum)[keyof typeof IQanaryComponentHealthStatusEnum];
 ...
 * @export
 */
export const QanaryServiceControllerApiAxiosParamCreator = (configuration?: Configuration) => ({
  /**
 ...
 * @export
 */
export const QanaryServiceControllerApiFp = (configuration?: Configuration) => {
  ...
  return {
    ...
    async readAbout(
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IQanaryComponentAbout>> {
    ...
    async readHealth(
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<IQanaryComponentHealth>> {
 ...
 * @export
 */
export const QanaryServiceControllerApiFactory = (
...
export class QanaryServiceControllerApi extends BaseAPI {
  ...
  public createAnnotation(iQanaryMessage: IQanaryMessage, options?: AxiosRequestConfig) {
    return QanaryServiceControllerApiFp(this.configuration)
      .createAnnotation(iQanaryMessage, options)
