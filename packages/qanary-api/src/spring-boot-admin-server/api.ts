 ...
 * @export
 */
export const SpringBootAdminServerApiAxiosParamCreator = (configuration?: Configuration) => ({
  /**
  ...
  createInstances: async (
    iComponentRegistrationInfo: IComponentRegistrationInfo,
 ...
 * @export
 */
export const SpringBootAdminServerApiFp = (configuration?: Configuration) => {
  ...
  return {
    ...
    async createInstances(
      iComponentRegistrationInfo: IComponentRegistrationInfo,
      options?: AxiosRequestConfig
    ): Promise<(axios?: AxiosInstance, basePath?: string) => AxiosPromise<ISpringBootAdminServerInstancesSuccess>> {
 ...
 * @export
 */
export const SpringBootAdminServerApiFactory = (
  ...
  return {
    ...
    createInstances(
      iComponentRegistrationInfo: IComponentRegistrationInfo,
      options?: any
    ): AxiosPromise<ISpringBootAdminServerInstancesSuccess> {
      return localVarFp
        .createInstances(iComponentRegistrationInfo, options)
...
export class SpringBootAdminServerApi extends BaseAPI {
  ...
  public createInstances(iComponentRegistrationInfo: IComponentRegistrationInfo, options?: AxiosRequestConfig) {
    return SpringBootAdminServerApiFp(this.configuration)
      .createInstances(iComponentRegistrationInfo, options)
