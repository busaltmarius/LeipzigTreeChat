...
export type BenchmarkAxis = "task_completion" | "grounding" | "flow_correctness" | "graceful_failure" | "presentation";
export type BenchmarkStatus = "pass" | "soft-fail" | "fail";
export type BenchmarkSignalTarget = "assistant_last" | "assistant_any" | "transcript" | "metadata";
export type BenchmarkMatchMode = "includes" | "regex";
export type ClarificationExpectation = "required" | "forbidden" | "allowed";
