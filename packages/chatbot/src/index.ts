...
export const ChatBotGraph = (
  ...
  const { UserInputNode, ResponseNode, RouterNode, QanaryOrchestratorNode } = Nodes(
    printMessage,
    START,
    END,
  ...
  return new StateGraph(AgentStateAnnotation)
    ...
    .addNode(
      ...
      { ends: [QANARY_ORCHESTRATOR_NODE_ID, CHATBOT_RESPONSE_NODE_ID, END, USER_INPUT_NODE_ID] }
    )
    .addNode(QANARY_ORCHESTRATOR_NODE_ID, QanaryOrchestratorNode({ nextNode: CHATBOT_RESPONSE_NODE_ID, errorNode: USER_INPUT_NODE_ID }), {
