...
Run started: 2026-03-22T16:00:27.077Z
Run finished: 2026-03-22T16:13:43.959Z
...
- Median case duration: 34111 ms

## Recommended Demo Subset

- `Q8` Bäume in der Umgebung einer Kita (soft-fail, 92.9%, 31816 ms)
- `D3` Dialog: Geeigneten Baum zum Gießen finden (fail, 87.5%, 126742 ms)
- `D2` Dialog: Wasserentnahmestellen in der Nähe (fail, 86.7%, 26701 ms)
- `D4` Dialog: Themenüberblick (fail, 86.7%, 60053 ms)
- `Q6` Patenbäume in meiner Nähe (fail, 85.7%, 35945 ms)
- `Q10` Bäume mit Trockenheitsstress (fail, 84.6%, 37575 ms)
...
- `Q1` Gießmenge nach Stadtteil (fail, 70.6%, 20708 ms)
  Reason: Keine generische Entschuldigung: Forbidden signal matched: Entschuldigung
- `Q2` Wasserentnahmestellen in der Nähe einer Adresse (fail, 80.0%, 55894 ms)
  Reason: Antwort thematisiert Wasserentnahmestellen: Required signal missing: Wasser
- `Q3` Geeigneten Baum zum Gießen finden (fail, 80.0%, 38333 ms)
...
- `D5` Dialog: Klärungsbedürftige Ortsanfrage (fail, 66.7%, 29183 ms)
  Reason: Antwort greift Connewitz nach der Klärung auf: Required signal missing: Connewitz
- `D6` Dialog: Graceful Failure mit Fallback (fail, 77.8%, 61030 ms)
