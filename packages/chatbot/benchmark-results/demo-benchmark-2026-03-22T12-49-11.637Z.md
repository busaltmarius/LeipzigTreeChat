...
Run started: 2026-03-22T12:49:11.381Z
Run finished: 2026-03-22T12:49:11.637Z
...
- Median case duration: 11 ms

## Recommended Demo Subset

- `Q8` Bäume in der Umgebung einer Kita (soft-fail, 92.9%, 10 ms)
- `D3` Dialog: Geeigneten Baum zum Gießen finden (fail, 87.5%, 21 ms)
- `D4` Dialog: Themenüberblick (fail, 86.7%, 6 ms)
- `D2` Dialog: Wasserentnahmestellen in der Nähe (fail, 86.7%, 14 ms)
- `Q6` Patenbäume in meiner Nähe (fail, 85.7%, 11 ms)
- `Q10` Bäume mit Trockenheitsstress (fail, 84.6%, 7 ms)
...
- `Q1` Gießmenge nach Stadtteil (fail, 82.4%, 54 ms)
  Reason: Antwort bezieht sich auf den Stadtteil: Required signal missing: Connewitz
- `Q2` Wasserentnahmestellen in der Nähe einer Adresse (fail, 80.0%, 16 ms)
  Reason: Antwort thematisiert Wasserentnahmestellen: Required signal missing: Wasser
- `Q3` Geeigneten Baum zum Gießen finden (fail, 80.0%, 9 ms)
...
- `D5` Dialog: Klärungsbedürftige Ortsanfrage (fail, 66.7%, 14 ms)
  Reason: Antwort greift Connewitz nach der Klärung auf: Required signal missing: Connewitz
- `D6` Dialog: Graceful Failure mit Fallback (fail, 77.8%, 19 ms)
